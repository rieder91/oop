...
public class Authenticator {
	...
	/**
	 * 
	 * @param askingAuth the auth wich asks for permission
	 * @param grantingAuth the auth from which permission is being asked
	 * @param m the method which askingAuth wishes to invoke
	 * @throws InsufficientPermissionsException if not allowed to invoke
	 */
	 ...
	 * @param auth auth-obj of which the permissions are printed
	 */
