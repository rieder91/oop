 ...
 * 
 * THIS CLASS IS FOR TESTING PURPOSES ONLY AND NOT PART OF THE ACTUAL SOLUTION
 * FOR THE ASSIGNMENT - THAT IS WHY WE USED GETCLASS!
 * 
 * @author Thomas
 * 
 */
public class FactoryTester implements Tester {
	...
	public void runTests() {
		...
		Android hilfFake = new Hilfskraft("Sonnic");
		...
		for (Android an : factory) {
			...
			order1.add(an.toString().substring(
					an.toString().indexOf("Serial:"),
					an.toString().indexOf("Software") - 1));
		}

		System.out.println("\nAttempt 5 illegal changes...\n");
		System.out.println("New robot added: "
				+ factory.insert(hilfFake, bSkin, hSoft1, kit1));
		System.out.println("New robot added: "
				+ factory.insert(gesell, bSkin, kSoft4, kit5));
		System.out.println("New robot added: "
				+ factory.insert(kampf, gSkin, lSoft5, kit10));
		System.out.println("New robot added: "
				+ factory.insert(bau, hSkin, bSoft3, kit10));
		System.out.println("New robot added: "
				+ factory.insert(leib, gSkin, hSoft1, kit5));
		...
		for (Android an : factory) {
			order3.add(an.toString().substring(
					an.toString().indexOf("Serial:"),
					an.toString().indexOf("Software") - 1));
		}
