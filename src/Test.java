...
public class Test {
	...
	public static void main(String[] args) {
		...
		Gig novarock2010 = null, novarock2011 = null, novarock2012 = null, case39 = null, case38 = null;
		...
		try {
			...
			// used in: 39, 40
			case39 = new Gig(formatTime.parse("11.07.2010 12:00"),
					"Pannonia Fields II", 72, 2500.0);
			// used in: 38
			case38 = new Gig(formatDate.parse("01.01.2013"), "Wien", 10,
		 ...
		 */
		System.out.println(""
				+ "Objektorientierte Programmiertechniken - Assignment 2\n"
				+ "Deadline: 24.10.2012\n" + "Group: 187\n"
