...
public class Test {
	...
	public static void main(String[] args) {
		...
		b2.addPosition(new Position(1, Form.RUND, Teigart.ZIMTSTERNTEIG,
				Fuellung.SCHOKOLADE));
		b2.addPosition(new Position(1, Form.MOND, Teigart.ZIMTSTERNTEIG,
				Fuellung.SCHOKOLADE));
		b2.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG, Fuellung.SCHOKOLADE));
		b2.addPosition(new Position(1, Form.RUND, Teigart.ZIMTSTERNTEIG,
				Fuellung.MARMELADE));
		b2.addPosition(new Position(1, Form.MOND, Teigart.ZIMTSTERNTEIG,
				Fuellung.MARMELADE));
		b2.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG, Fuellung.MARMELADE));
		...
		b3.addPosition(new Position(1, Form.RUND, Teigart.MUERBTEIG,
				Fuellung.SCHOKOLADE));
		b3.addPosition(new Position(1, Form.MOND, Teigart.MUERBTEIG,
				Fuellung.SCHOKOLADE));
		b3.addPosition(new Position(1, Form.WEIHNACHTSMANN, Teigart.MUERBTEIG,
				Fuellung.SCHOKOLADE));
		b3.addPosition(new Position(1, Form.RUND, Teigart.MUERBTEIG,
				Fuellung.MARMELADE));
		b3.addPosition(new Position(1, Form.MOND, Teigart.MUERBTEIG,
		...
		b4.addPosition(new Position(1, Form.RUND, Teigart.SCHOKOLADENTEIG,
				Fuellung.SCHOKOLADE));
		b4.addPosition(new Position(1, Form.MOND, Teigart.SCHOKOLADENTEIG,
				Fuellung.SCHOKOLADE));
		b4.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.SCHOKOLADENTEIG, Fuellung.SCHOKOLADE));
		b4.addPosition(new Position(1, Form.RUND, Teigart.SCHOKOLADENTEIG,
				Fuellung.MARMELADE));
		b4.addPosition(new Position(1, Form.MOND, Teigart.SCHOKOLADENTEIG,
				Fuellung.MARMELADE));
		b4.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.SCHOKOLADENTEIG, Fuellung.MARMELADE));
		...
		b5.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG, null));
		...
		b6.addPosition(new Position(1, Form.WEIHNACHTSMANN, Teigart.MUERBTEIG,
				null));
		...
		b7.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.SCHOKOLADENTEIG, null));
		...
		b8.addPosition(new Position(-7, Form.MOND, Teigart.SCHOKOLADENTEIG,
				null));
		b8.addPosition(new Position(-2, Form.RUND, Teigart.ZIMTSTERNTEIG, null));
		b8.addPosition(new Position(0, Form.WEIHNACHTSMANN,
				Teigart.SCHOKOLADENTEIG, null));
		...
		for (int i = 0; i < 10; i++) {
			b11.addPosition(new Position(2, Form.RUND, Teigart.SCHOKOLADENTEIG,
					Fuellung.MARMELADE));
		}
		...
		b14.addPosition(new Position(0, Form.RUND, Teigart.SCHOKOLADENTEIG,
				Fuellung.SCHOKOLADE));

		System.out
				.println("\nEine ungueltige Bestellung mit einem Doppelkeks:");
		b14.drucke();
		System.out.println();
		b.backe(b14).inhalt();
		...
		b15.addPosition(new Position(0, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG));

		System.out
				.println("\nEine ungueltige Bestellung mit einem einfachen Keks: ");
		b15.drucke();
		System.out.println();
		b.backe(b15).inhalt();
		...
		b1.addPosition(new Position(5, Form.RUND, Teigart.SCHOKOLADENTEIG,
				Fuellung.MARMELADE));
		b1.addPosition(new Position(2, Form.RUND, Teigart.SCHOKOLADENTEIG, null));
		b1.addPosition(new Position(0, Form.MOND, Teigart.MUERBTEIG,
				Fuellung.SCHOKOLADE));
		b1.addPosition(new Position(4, Form.MOND, Teigart.MUERBTEIG, null));
		b1.addPosition(new Position(3, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG, Fuellung.MARMELADE));
		b1.addPosition(new Position(1, Form.WEIHNACHTSMANN,
				Teigart.ZIMTSTERNTEIG, null));
		b1.addPosition(new Position(10, Form.RUND, Teigart.SCHOKOLADENTEIG,
				Fuellung.SCHOKOLADE));

		System.out
				.println("Ein Mix verschiedener Kekse mit unterschiedlicher Anzahl:");
		b1.drucke();
		System.out.println();
		b.backe(b1).inhalt();
