...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Member thomas = new Member("Thomas", "Rieder", "Keyboard", "+43699123123");
			Member markus = new Member("Markus", "Zisser", "Guitar", "01123123123");
			Member dominic = new Member("Dominic", "Riedl", "Drums", "0699123456");
			
			Gig novarock2010 = new Gig(format.parse("11.07.2010"), "Pannonia Fields II", 72, 2500.0);
			Gig novarock2011 = new Gig(format.parse("11.07.2011"), "Pannonia Fields II", 72, 5000.0);
			Gig novarock2012 = new Gig(format.parse("08.07.2012"), "Pannonia Fields II", 72, 10000.0);
			
			Rehearsal postNova2010 = new Rehearsal(format.parse("15.08.2010"), "Vienna Sound Studio", 5, 100.0);
			Rehearsal postNova2011 = new Rehearsal(format.parse("15.08.2011"), "Vienna Sound Studio Mk II", 7, 1000.0);
			...
			// Several queries
			try {	
				System.out.println(ultraCoders.getTracks(format.parse("29.05.2011")));
				System.out.println(ultraCoders.getMembers(format.parse("29.06.2011")));
				System.out.println(ultraCoders.getEvents(format.parse("01.01.2010"), format.parse("01.01.2012"), types));
				System.out.println(ultraCoders.getBilling(format.parse("01.01.2010"), format.parse("01.01.2012"), types));
			} catch (InvalidDateException e) {
				System.out.println(e.getMessage());
			}
