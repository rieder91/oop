...
public class Test1 implements Tester {
	...
	public void runTests() {
		...
		Car c2 = new ManeuverableCar(12, new LeftCircleStrategy(), 40, 12, Direction.South, t);
		Car c3 = new ManeuverableCar(13, new ZigzagStrategy(), 40, 8, Direction.North, t);
		Car c4 = new ManeuverableCar(12, new LeftCircleStrategy(), 42, 10, Direction.West, t);
		...
		Car c7 = new FastCar(6, new LeftCircleStrategy(), 42, 8, Direction.West, t);
		Car c8 = new FastCar(4, new ZigzagStrategy(), 38, 12, Direction.East, t);
		Car c9 = new FastCar(6, new LeftCircleStrategy(), 38, 8, Direction.East, t);
		Car c10 = new FastCar(4, new RandomStrategy(), 40, 14, Direction.South, t);
		Car c11 = new ManeuverableCar(12, new LeftCircleStrategy(), 40, 6, Direction.North, t);
		Car c12 = new ManeuverableCar(15, new RandomStrategy(), 36, 10, Direction.East, t);
		Car c13 = new FastCar(6, new LeftCircleStrategy(), 42, 10, Direction.West, t);
		t.addCar(c1);
		t.addCar(c2);
		t.addCar(c3);
		t.addCar(c4);
