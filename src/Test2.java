...
public class Test2 implements Tester {
	...
	public void runTests() {
		...
		Car c2 = new FastCar(4, new LeftCircleStrategy(), 20, 12, Direction.North, t);
		...
		Car c6 = new FastCar(6, new LeftCircleStrategy(), 22, 12, Direction.West, t);
		Car c7 = new FastCar(4, new RandomStrategy(), 18, 10, Direction.East, t);
		Car c8 = new FastCar(6, new LeftCircleStrategy(), 18, 12, Direction.East, t);
